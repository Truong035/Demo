...
import static DES.ChuoiNhiPhan.ChuyenNhiPhanSangSo;
...
public class ChuoiNhiPhan {
       public long [] MangNhiPhan ; // chứa mảng nhị phân ví dụ: 011011011010
        ...
        {
            MangNhiPhan = new long[doDai];
        }
        /// <summary>
        /// Tạo 1 chuỗi từ một mảng nhị phân
        /// </summary>
        /// <param name="mangNhiPhan"></param>
        public ChuoiNhiPhan(long [] mangNhiPhan)
        {
     ...
     //   #region Cac Ham convert
        ...
        public static ChuoiNhiPhan ChuyenChuSangChuoiNhiPhan(String ChuoiVao)
        {
            try
            {
                ...
                long[] mangNhiPhan = new long[ChuoiVao.length()];
                for (int i = ChuoiVao.length() - 1; i >= 0; i--)
                {
                    mangNhiPhan[i] = Integer.parseInt(ChuoiVao.charAt(i)+"");
                }
           ...
           public ChuoiNhiPhan Cat(int viTriBatDau, int SoLuong) // vị trí căt và số lượng bit bị cắt
        {
            long[] mangNhiPhanDuocCat = new long[SoLuong];
        ...
        public static int ChuyenNhiPhanSangSo(String ChuoiVao)
        {
            ...
            for (int i = ChuoiVao.length() - 1; i >= 0; i--)
            {
                KQ +=  Integer.parseInt(ChuoiVao.charAt(i)+"") * (int)Math.pow(2, ChuoiVao.length() - i - 1);
            }
            return KQ;
        }
        /// <summary>
         ...
         public ChuoiNhiPhan CatDuLieu64()
        {
            ...
            int d = ChuoiNhiPhan.ChuyenNhiPhanSangSo(ChuoiChieuDai); // chuyển sang số
